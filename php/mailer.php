...
try {
	...
	echo "<div class=\"alert alert-success\" role=\"alert\">Email sent successfully. Thanks!</div>";

} catch(Exception $exception) {
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>Oh no!</strong> Unable to send email: " . $exception->getMessage() . "</div>";
}