...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title> @brentTheDev | Creator/Developer </title>
	...
	<body>
		...
		<section class="bg-secondary py-5">
			<div class="container">
				<div class="row">
					<div class="col-sm-3">
						<img class="img-fluid rounded-circle mb-4" src="bart.jpg" alt="fractal">
					</div>
					<div class="col-sm-9">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-sm-6">
						<img class="img-fluid rounded-circle d-block mx-auto mb-4" src="bart.jpg" alt="Card image cap">
						<div class="card mb-4">
							<div class="card-body">
